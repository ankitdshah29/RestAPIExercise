...
public class Alt_fuel_station {
	...
	private Ev_network_ids ev_network_ids;
	...
	public Ev_network_ids getEv_network_ids() {
		return ev_network_ids;
	}

	public void setEv_network_ids(Ev_network_ids ev_network_ids) {
		this.ev_network_ids = ev_network_ids;
	}
	...
	public void setEv_dc_fast_num(String ev_dc_fast_num) {
	...
	public void setEv_level2_evse_num(String ev_level2_evse_num) {
	...
	public void setEv_level1_evse_num(String ev_level1_evse_num) {
